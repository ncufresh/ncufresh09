<?php /* Smarty version 2.6.18, created on 2009-08-06 04:21:34
         compiled from chgpage.tpl.php */ ?>
﻿<div id="QA_MAIN_OUTER">
	<div id="QA_navigate_bar">
		...
		分類:
			<select name="select" value="<?php echo $this->_tpl_vars['QA_Articals']['cls']; ?>
">
...
"><?php echo $this->_tpl_vars['QA_cls'][$this->_sections['loop']['index']]['content']; ?>
		...
		標題:
			<input name="title" type="text" value="<?php echo $this->_tpl_vars['QA_Articals']['title']; ?>
"/><br /><br />
		<div style="float:left">內容:</div>
			<textarea rows="10" cols="70" name="descript"><?php echo $this->_tpl_vars['QA_Articals']['content']; ?>
</textarea><br /><br />
